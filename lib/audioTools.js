			...
			fs.readdir('./downloaded', function(err, files){
				...
				if(result){
					...
					if(force){
						...
						serverGlobal.process.kill();

						//Il dégage de la mémoire
						serverGlobal.process = null;
						
						//Mise à jour de serverGlobal

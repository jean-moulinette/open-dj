...
if(typeof process.argv[2] == 'undefined'){
	...
	if(process.argv[2] === 'searchYoutube'){
		 ...
		 */
		var downloadCommand = 'cd downloaded && youtube-dl -w -o "%(id)s.%(ext)s" --youtube-skip-dash-manifest  --no-check-certificate --extract-audio --audio-format mp3 --no-part "'+url+'"';
	...
	if(process.argv[2] === 'playSound'){
		...
		var playingProcess = child.exec('cd downloaded && mplayer -- '+fileToPlay);
